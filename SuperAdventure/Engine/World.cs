...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateMonsters()
        {
            ...
            Monster giantSpider = new Monster(MONSTER_ID_GIANT_SPIDER, "Giant Spider", 12, 10, 40, 10, 10);
        ...
        private static void PopulateLocations()
        {
            ...
            Location townSquare = new Location(LOCATION_ID_TOWN_SQUARE, "Town square", "You see a fountain in front of you.");
